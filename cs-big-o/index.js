...
// ANSWER: no becasue since we know exactly what we are looking for my time complexity would be the same as the current code
...
// ANSWER: both of them are dependant on the length of the string that you input
